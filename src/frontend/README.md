...
- `VITE_PARENT_GATE_WEBAUTHN_TIMEOUT_MS`, `VITE_PARENT_GATE_WEBAUTHN_USER_ID_MAX_LENGTH`, `VITE_PARENT_GATE_WEBAUTHN_USER_ID_PROTOCOL_MAX_LENGTH`, `VITE_PARENT_GATE_WEBAUTHN_USER_VERIFICATION` (`required` | `preferred` | `discouraged`)
